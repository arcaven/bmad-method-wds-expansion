...
**Template:** Use `_agent-dialogs/templates/dialog-types/stitch-generation.template.md`
...
**WDS Templates:**
- Dialog template: `_agent-dialogs/templates/dialog-types/stitch-generation.template.md`

---

_Stitch UI Generation Workflow — Freya WDS Designer — Phase 6 Asset Generation_
