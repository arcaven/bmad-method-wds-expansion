...
**Start here**: `{installed_path}/substeps/01-start-understand/01-understand-situation.md`

**Substeps Available**:
- **35 substeps** organized into 6 phase folders (each with its own `workflow.md`)

**Step Files** (main workflow steps):
- `{installed_path}/steps-c/step-01-start.md` (references substeps)

**Workflow Phases** (organized in subfolders):
1. **Start & Understand** (`01-start-understand/`) - 5 steps
2. **Explore Sections** (`02-explore-sections/`) - 11 steps (flexible order)
3. **Synthesize & Present** (`03-synthesize-present/`) - 4 steps (includes VTC creation)
4. **Generate Signoff** (`04-generate-signoff/`) - 2 steps
5. **Build Contract** (`05-build-contract/`) - 12 steps
6. **Build Internal Signoff** (`06-build-signoff-internal/`) - 2 steps
...
→ `{project-root}/_bmad/wds/workflows/1-project-brief/101-project-brief/workflow.md`
