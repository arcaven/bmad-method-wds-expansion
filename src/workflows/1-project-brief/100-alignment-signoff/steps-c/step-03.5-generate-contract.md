...
`substeps/04-generate-signoff/01-offer-signoff-document.md`
...
`substeps/04-generate-signoff/02-determine-business-model.md`
...
If user chose contract or service agreement, execute steps 01-12 in sequence:

1. `substeps/05-build-contract/01-build-section-01-project-overview.md`
2. `substeps/05-build-contract/02-build-section-02-business-model.md`
3. `substeps/05-build-contract/03-build-section-03-scope-of-work.md`
4. `substeps/05-build-contract/04-build-section-04-payment-terms.md`
5. `substeps/05-build-contract/05-build-section-05-timeline.md`
6. `substeps/05-build-contract/06-build-section-06-availability.md`
7. `substeps/05-build-contract/07-build-section-07-confidentiality.md`
8. `substeps/05-build-contract/08-build-section-08-not-to-exceed.md`
9. `substeps/05-build-contract/09-build-section-09-work-initiation.md`
10. `substeps/05-build-contract/10-build-section-10-terms-and-conditions.md`
11. `substeps/05-build-contract/11-build-section-11-approval.md`
12. `substeps/05-build-contract/12-finalize-contract.md`

### Internal Signoff Document (if internal signoff selected)

If user chose internal signoff, execute steps 01-02:

1. `substeps/06-build-signoff-internal/01-build-internal-signoff.md`
2. `substeps/06-build-signoff-internal/02-finalize-signoff.md`
