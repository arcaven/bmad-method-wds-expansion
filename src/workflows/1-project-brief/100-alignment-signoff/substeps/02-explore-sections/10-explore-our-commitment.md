# Substep 10: Explore Our Commitment
...
**Reference**: `{installed_path}/substeps/02-explore-sections/workflow.md` (Section 9: Our Commitment)
...
→ `11-explore-summary.md` (same folder)
