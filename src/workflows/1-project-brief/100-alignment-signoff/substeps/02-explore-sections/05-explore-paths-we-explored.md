# Substep 05: Explore Paths We Explored
...
**Reference**: `{installed_path}/substeps/02-explore-sections/workflow.md` (Section 4: Paths We Explored)
...
→ `06-explore-recommended-solution.md` (same folder)
