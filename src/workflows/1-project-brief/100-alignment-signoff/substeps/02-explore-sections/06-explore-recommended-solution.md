# Substep 06: Explore Recommended Solution
...
**Reference**: `{installed_path}/substeps/02-explore-sections/workflow.md` (Section 5: Recommended Solution)
...
→ `07-explore-path-forward.md` (same folder)
