# Substep 07: Explore The Path Forward
...
**Reference**: `{installed_path}/substeps/02-explore-sections/workflow.md` (Section 6: The Path Forward)
...
→ `08-explore-value-we-create.md` (same folder)
