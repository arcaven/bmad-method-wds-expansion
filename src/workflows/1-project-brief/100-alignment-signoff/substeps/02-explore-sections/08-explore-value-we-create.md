# Substep 08: Explore The Value We'll Create
...
**Reference**: `{installed_path}/substeps/02-explore-sections/workflow.md` (Section 7: The Value We'll Create)
...
→ `09-explore-cost-of-inaction.md` (same folder)
