# Substep 03: Explore Why It Matters
...
**Reference**: `{installed_path}/substeps/02-explore-sections/workflow.md` (Section 2: Why It Matters)
...
→ `04-explore-how-we-see-it-working.md` (same folder)
