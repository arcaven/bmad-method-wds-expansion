# Substep 01: Explore The Realization
...
**Reference**: `{installed_path}/substeps/02-explore-sections/workflow.md` (Section 1: The Realization)
...
→ `03-explore-why-it-matters.md` (same folder)
