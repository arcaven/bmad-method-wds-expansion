# Substep 03: Create Value Trigger Chain
...
> `{project-root}/_bmad/wds/workflows/1-project-brief/_vtc-workshop/workflow.md`
> 
...
→ `04-present-for-approval.md` (same folder)
