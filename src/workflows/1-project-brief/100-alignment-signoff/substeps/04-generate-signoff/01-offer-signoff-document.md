# Substep 01: Offer to Generate Signoff Document
...
→ `02-determine-business-model.md` (same folder - for external contracts)
→ `../06-build-signoff-internal/01-build-internal-signoff.md` (for internal signoff)
