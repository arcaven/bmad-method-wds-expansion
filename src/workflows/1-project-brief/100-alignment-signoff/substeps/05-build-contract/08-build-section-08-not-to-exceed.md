# Substep 08: Build Section 8 - Not to Exceed Clause (Conditional)
...
**If section applies**:
→ `09-build-section-09-work-initiation.md` (same folder)

**If section doesn't apply** (Retainer):
→ `09-build-section-09-work-initiation.md` (same folder - skip this section)
