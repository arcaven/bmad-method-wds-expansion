...
**Note:** Alignment & Signoff is now a separate, optional workflow. If you need stakeholder approval before starting, use the alignment & signoff workflow first: `{project-root}/_bmad/wds/workflows/1-project-brief/100-alignment-signoff/workflow.md`
