...
**File:** `substeps/02-positioning/01-open-conversation.md`
**Task:** Introduce positioning naturally, invite user to think about market fit

### Substep 2: Explore Positioning
**File:** `substeps/02-positioning/02-explore-positioning.md`
...
**File:** `substeps/02-positioning/03-reflect-confirm.md`
...
**File:** `substeps/02-positioning/04-synthesize-document.md`
...
**Start:** Load and execute `substeps/02-positioning/01-open-conversation.md`
