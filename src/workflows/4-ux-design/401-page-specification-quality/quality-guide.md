...
- [Design Deliveries](../../../8-design-deliveries/) - Packages specs for handoff
- [Platform Requirements](../../../1-project-brief/106-platform-requirements/) - Technical boundaries from specs
