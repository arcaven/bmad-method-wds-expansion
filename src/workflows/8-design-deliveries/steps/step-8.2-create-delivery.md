# Step 8.2: Create Design Delivery
...
- ✅ Completed step 8.1 (flow is complete)
...
`substeps/8.2-substeps/01-initialize-delivery.md`
...
Load, read completely, then execute:
`substeps/8.2-substeps/02-define-user-value.md`
...
Load, read completely, then execute:
`substeps/8.2-substeps/03-list-artifacts.md`
...
Load, read completely, then execute:
`substeps/8.2-substeps/04-define-technical.md`
...
Load, read completely, then execute:
`substeps/8.2-substeps/05-define-acceptance.md`
...
Load, read completely, then execute:
`substeps/8.2-substeps/06-add-testing-guidance.md`
...
Load, read completely, then execute:
`substeps/8.2-substeps/07-estimate-complexity.md`
...
<action>Load and execute: step-8.3-create-test-scenario.md</action>
