# Step 8.1: Detect Epic Completion
...
```
[C] Continue to step-8.2-create-delivery.md
```
...
After confirming completion, load `./step-8.2-create-delivery.md` to create the Design Delivery.
