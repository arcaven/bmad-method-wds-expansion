...
- ✅ Completed step 8.2 (Design Delivery created)
...
`substeps/8.3-substeps/01-initialize-test-scenario.md`
...
Load, read completely, then execute:
`substeps/8.3-substeps/02-define-happy-path.md`
...
Load, read completely, then execute:
`substeps/8.3-substeps/03-define-error-states.md`
...
Load, read completely, then execute:
`substeps/8.3-substeps/04-define-edge-cases.md`
...
Load, read completely, then execute:
`substeps/8.3-substeps/05-define-design-validation.md`
...
Load, read completely, then execute:
`substeps/8.3-substeps/06-define-accessibility.md`
...
Load, read completely, then execute:
`substeps/8.3-substeps/07-define-signoff-criteria.md`
...
<action>Load and execute: step-8.4-handoff-dialog.md</action>
