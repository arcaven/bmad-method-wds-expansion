# Lesson 12: Using VTCs Strategically Across Your Project

**Time: 20 min | Focus: Strategy | Prerequisites: Tutorial 06B**

---

## Beyond Your First VTC

Tutorial 06B taught you how to create a single Value Trigger Chain. This lesson covers the bigger picture: when to use VTCs, how they fit into different project phases, and how to manage multiple VTCs across a complex product.
...
Run Selection Workshop but be prepared for refinement. May discover need to update Trigger Map.

### Q: Can I create VTC now and Trigger Map later?

Absolutely! VTC is a lightweight start. As project grows, create Trigger Map and extract more VTCs from it. Original VTC becomes input to Trigger Map.
...
### Scenario VTC
**Location:** `docs/C-UX-Scenarios/[scenario-name]/vtc.yaml`
...
- [Tutorial 06B: Create Your Value Trigger Chain](tutorial-06b-value-trigger-chain.md) — Hands-on VTC creation
- [Lesson 2: Heritage & Evolution](lesson-02-heritage-evolution.md) — VTC vs Trigger Map origins
- [Tutorial 06: Create Your Trigger Map](tutorial-06.md) — Full mapping process

---

[← Back to Module Overview](module-06-overview.md) | [Tutorial 06B: Create Your VTC →](tutorial-06b-value-trigger-chain.md)
